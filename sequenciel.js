...
const reponses = [
  //"💡Reponses Quizz 1 – À quoi sert la broche GND sur Arduino ?\nBonne réponse : 🟡 Se connecter à la masse électrique",
  //"💡Reponses Quizz 2 – Que fait une résistance ?\nBonne réponse : 🔴 Limite le courant électrique",
  //"💡Reponses Quizz 3 – Quelle est la vitesse standard de Serial.begin ?\nBonne réponse : 🔴 9600 bauds",
  //"💡Reponses Quizz 4 – Quel composant stocke une charge électrique ?\nBonne réponse : 🟡 Condensateur",
  "💡Reponses Quizz 5 – À quoi sert la fonction delay() sur Arduino ?\nBonne réponse : 🔴 Attendre un certain temps",
  "💡Reponses Quizz 6 – L’IA apprend à partir de :\nBonne réponse : 🟡 Données",
  "💡Reponses Quizz 7 – Un neurone artificiel :\nBonne réponse : 🔴 Traite un signal d’entrée",
  "💡Reponses Quizz 8 – Le machine learning sert à :\nBonne réponse : 🟣 Prédire à partir d’exemples",
  "💡Reponses Quizz 9 – Le deep learning utilise :\nBonne réponse : 🟡 Des réseaux de neurones profonds",
  "💡Reponses Quizz 10 – Une image peut être comprise par une IA en la transformant en :\nBonne réponse : 🟡 Données numériques",
  "💡Reponses Quizz 11 – Le capteur LDR détecte :\nBonne réponse : 🔴 La lumière",
  "💡Reponses Quizz 12 – Quelle fonction mesure une tension analogique sur Arduino ?\nBonne réponse : 🟡 analogRead()",
  "💡Reponses Quizz 13 – L’unité de la tension est :\nBonne réponse : 🟡 Volt",
  "💡Reponses Quizz 14 – En IA, NLP signifie :\nBonne réponse : 🔴 Natural Language Processing",
  "💡Reponses Quizz 15 – L’IA générative peut :\nBonne réponse : 🔴 Écrire des textes, images, sons",
  "💡Reponses Quizz 16 – Quel composant est polarisé ?\nBonne réponse : 🔴 LED",
  "💡Reponses Quizz 17 – Que mesure le capteur DHT11 ?\nBonne réponse : 🔴 Température et humidité",
  "💡Reponses Quizz 18 – L’apprentissage supervisé signifie :\nBonne réponse : 🔴 On lui fournit des exemples avec réponses",
  "💡Reponses Quizz 19 – Une breadboard sert à :\nBonne réponse : 🔴 Prototyper sans souder",
  "💡Reponses Quizz 20 – Une IA bien entraînée peut :\nBonne réponse : 🔴 Répondre avec logique sur des cas appris"
];
//=============================== VARIABLES ===============================//
// 'TTECH™ |  Général'
const groupName = 'TTECH™ |  Général';
const mediaDir = path.join(__dirname, 'media/answers');
let currentIndex = 0;
//=============================== CLIENT INIT ===============================//
...
client.on('message', async message => {
  if (!message.fromMe && message.body.startsWith('!ask')) {
    ...
    try {
      ...
      console.log('✅ Message enregistré dans memoire.json');
    } catch (err) {
